...
public class AddAndSubView extends LinearLayout {
	...
	private void setViewsLayoutParm() {
		...
		editText.setTextColor(Color.rgb(61, 61, 61));
	...
	private void setTextWidthHeight() {
		...
		centerLinearLayout
				.setMinimumWidth(dip2px(context, editTextMinimumWidth));
	...
	class OnTextChangeListener implements TextWatcher {
		...
		public void afterTextChanged(Editable s) {
			...
			if (numString == null || numString.equals("")) {
				...
				if (numInt < 1) {
					Toast.makeText(context, "亲，数量至少为1哦~", Toast.LENGTH_SHORT)
							.show();
					editText.setText("1");
				} else {
