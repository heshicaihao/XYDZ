...
public class TabOrderChildAdapter extends BaseAdapter {
	...
	public TabOrderChildAdapter(Activity mActivity, Context context,
			JSONArray mData) {
		this.mData = mData;
...
//		bitmapUtils.configDiskCacheEnabled(false);
	...
	private void setData2UI(int position) {
		try {
			...
			JSONObject urls = object.getJSONObject("goods_pic");
			if (urls!=null) {
				String url = urls.optString("m_url");
...
//					}
			...
			String goods_price = object.optString("goods_price");
